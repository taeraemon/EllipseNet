...
# python main.py eldet --exp_id 0204_eldet_fhd_dla_iouw5_nocrop_896x608_step --dataset coco_fhd --batch_size 24 --lr 5e-4 --gpus 5 --num_workers 16 --num_epochs 100 --input_h 608 --input_w 896 --iou_weight 0 --ellipse_weight 0 --hm_weight 1 --off_weight 1 --wh_weight 0.1 --not_rand_crop 

# python main.py eldet --exp_id 0204_eldet_fhd_dla_iouw5_nocrop_896x608_step --dataset coco_fhd --batch_size 24 --lr 5e-4 --gpus 0 --num_workers 16 --num_epochs 200 --input_h 608 --input_w 896 --iou_weight 0 --ellipse_weight 1 --theta_weight 0 --hm_weight 0.1 --off_weight 0.1 --wh_weight 0.01 --not_rand_crop --resume

# python main.py eldet --exp_id 0204_eldet_fhd_dla_iouw5_nocrop_896x608_step --dataset coco_fhd --batch_size 20 --lr 5e-4 --gpus 0 --num_workers 16 --num_epochs 300 --input_h 608 --input_w 896 --iou_weight 0 --ellipse_weight 1 --theta_weight 5 --hm_weight 0.1 --off_weight 0.1 --wh_weight 0.01 --not_rand_crop --resume

python main.py eldet --exp_id 0204_eldet_fhd_dla_iouw5_nocrop_896x608_step --dataset coco_fhd --batch_size 20 --lr 5e-4 --gpus 0 --num_workers 16 --num_epochs 500 --input_h 608 --input_w 896 --iou_weight 1 --ellipse_weight 0.1 --theta_weight 10 --hm_weight 0.1 --off_weight 0.1 --wh_weight 0.01 --not_rand_crop --resume
