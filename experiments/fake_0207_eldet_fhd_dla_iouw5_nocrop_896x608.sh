cd src
# train
python main.py eldet --exp_id fake_0207_eldet_fhd_dla_iouw5_nocrop_896x608 --dataset coco_fhd --data_dir /data/cc/Data/CHD/fake_data/ --batch_size 24 --lr 1e-3 --gpus 5 --num_workers 16 --num_epochs 1000 --input_h 608 --input_w 896 --iou_weight 2 --not_rand_crop --scale 0 --shift 0 --resume
