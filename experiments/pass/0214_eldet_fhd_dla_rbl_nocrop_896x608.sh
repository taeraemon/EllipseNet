cd src
# train
python main.py eldet --exp_id 0214_eldet_fhd_dla_rbl_nocrop_896x608 --dataset coco_fhd --batch_size 24 --lr 5e-4 --gpus 5 --num_workers 16 --num_epochs 2000 --input_h 608 --input_w 896 --iou_weight 2 --not_rand_crop 
# test
